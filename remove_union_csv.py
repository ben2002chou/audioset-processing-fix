...
csv2 = pd.read_csv('/home/ben2002chou/code/audioset-processing-fix/data/unbalanced_train_segments_missing_2.csv')
csv1 = pd.read_csv('/home/ben2002chou/code/audioset-processing-fix/data/unbalanced_train_segments_missing_extraction_2.csv')
...
difference.to_csv('/home/ben2002chou/code/audioset-processing-fix/data/unbalanced_train_segments_missing_extraction_dif.csv', index=False)
